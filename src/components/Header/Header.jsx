      ...
      <div className={`container ${styles.headerContainer}`}>
        ...
        <nav className={styles.desktopNav}>
          <ul className={styles.navLinks}>
            <li><NavLink to="/emprendedores" className={({ isActive }) => isActive ? `${styles.navLink} ${styles.active}` : styles.navLink}>Soy emprendedor</NavLink></li>
      ...
      <div className={`${styles.mobileNav} ${isMobileMenuOpen ? styles.isOpen : ''}`}>
        <nav className={styles.mobileNavContent}>
          <ul className={styles.mobileNavLinks}>
            <li><NavLink to="/emprendedores" className={({ isActive }) => isActive ? styles.active : ''} onClick={toggleMenu}>Soy emprendedor</NavLink></li>
